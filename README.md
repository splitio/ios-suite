...
Below is a simple swift example that describes the instantiation and most basic usage of our SDK:
...
Please refer to [iOS Suite](https://help.split.io/hc/en-us/articles/26408115004429-iOS-Suite) to learn about all the functionality provided by the library as well as specifics for configuration options available for tailoring it to your current application setup.
